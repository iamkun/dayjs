...
it('FromString', ()  => {
  ...
  expect(fromString('2018-13-25')).toBe(null)
  expect(fromString('2018-00-25')).toBe(null)
  expect(fromString('2018-02-00 00:00:00:000').toString()).toEqual('Invalid Date')
  expect(fromString('2018-02-31 00:00:00:000').toString()).toEqual('Invalid Date')
  expect(fromString('2018-02-14 24:00:00:000').toString()).toEqual('Invalid Date')
  expect(fromString('2018-02-14 23:60:00:000').toString()).toEqual('Invalid Date')
  expect(fromString('2018-02-14 23:59:60:000').toString()).toEqual('Invalid Date')
