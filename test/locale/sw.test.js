...
describe('yearStart: 4 - ISO 8601 week numbering (sw locale)', () => {
  ...
  const cases = [
    ...
    ['2019-12-30', 1, 'Dec 30 2019 swlls into week 1 of 2020'],
  ...
  it('locale object exposes yearStart as 4', () => {
    const swLocale = dayjs()
      .locale('sw')
      .$locale()
    expect(swLocale.yearStart).toBe(4)
  })
})
