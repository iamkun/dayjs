...
describe('yearStart: 4 - ISO 8601 week numbering (ms-my locale)', () => {
  // yearStart: 4 ms-myans the first week of the year is the one containing Jan 4
  ...
  it('locale object exposes yearStart as 4', () => {
    const msMyLocale = dayjs()
      .locale('ms-my')
      .$locale()
    expect(msMyLocale.yearStart).toBe(4)
  })
})
