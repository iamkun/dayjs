...
describe('yearStart: 4 - ISO 8601 week numbering (ug-cn locale)', () => {
  ...
  const cases = [
    ...
    ['2019-12-30', 1, 'Dec 30 2019 ug-cnlls into week 1 of 2020'],
  ...
  it('locale object exposes yearStart as 4', () => {
    const ugcnLocale = dayjs()
      .locale('ug-cn')
      .$locale()
    expect(ugcnLocale.yearStart).toBe(4)
  })
})
