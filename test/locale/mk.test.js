...
describe('yearStart: 4 - ISO 8601 week numbering (mk locale)', () => {
  // yearStart: 4 mkans the first week of the year is the one containing Jan 4
  ...
  it('locale object exposes yearStart as 4', () => {
    const mkLocale = dayjs()
      .locale('mk')
      .$locale()
    expect(mkLocale.yearStart).toBe(4)
  })
})
