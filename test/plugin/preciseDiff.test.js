...
it('Diff of two time returnValueObject=true', () => {
  expect( JSON.stringify(dayjs.preciseDiff(dayjs('2014-01-31 12:00:00'),dayjs('2014-02-03 15:04:05'),true)) ).toBe(JSON.stringify({"years":0,"months":0,"days":3,"hours":3,"minutes":4,"seconds":5,"firstDateWasLater":false}));
})

it('Diff of two same time returnValueObject=true', () => {
  expect( JSON.stringify(dayjs.preciseDiff(dayjs('2014-02-03 15:04:05'),dayjs('2014-02-03 15:04:05'),true)) ).toBe(JSON.stringify({"years":0,"months":0,"days":0,"hours":0,"minutes":0,"seconds":0,"firstDateWasLater":false}));
})
