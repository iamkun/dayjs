...
describe('strict', () => {
  it('should return valid date for valid input', () => {
    expect(dayjs('2018-02-28T12:34:56.789Z').isValid()).toBeTruthy()
    expect(dayjs('2018-02-28 12:34:56:789').isValid()).toBeTruthy()
    expect(dayjs('2018-02-28').isValid()).toBeTruthy()
    expect(dayjs('2020-02-29T12:34:56.789Z').isValid()).toBeTruthy()
    expect(dayjs('2020-02-29 12:34:56:789').isValid()).toBeTruthy()
    expect(dayjs('2020-02-29').isValid()).toBeTruthy()
    expect(dayjs(undefined).isValid()).toBeTruthy()
    expect(dayjs().isValid()).toBeTruthy()
    expect(dayjs(new Date()).isValid()).toBeTruthy()
    expect(dayjs('2018-02').isValid()).toBeTruthy()

    expect(dayjs('2018-02-28T12:34:56.789Z', { utc: true }).isValid()).toBeTruthy()
    expect(dayjs('2018-02-28 12:34:56:789', { utc: true }).isValid()).toBeTruthy()
    expect(dayjs('2018-02-28', { utc: true }).isValid()).toBeTruthy()
    expect(dayjs('2020-02-29T12:34:56.789Z', { utc: true }).isValid()).toBeTruthy()
    expect(dayjs('2020-02-29 12:34:56:789', { utc: true }).isValid()).toBeTruthy()
    expect(dayjs('2020-02-29', { utc: true }).isValid()).toBeTruthy()
    expect(dayjs(undefined, { utc: true }).isValid()).toBeTruthy()
    expect(dayjs(new Date(), { utc: true }).isValid()).toBeTruthy()
    expect(dayjs('2018-02', { utc: true }).isValid()).toBeTruthy()
  })

  it('should return invalid date for invalid input', () => {
    expect(dayjs('2018-02-29').isValid()).toBeFalsy()
    expect(dayjs('2018-02-29 12:34:56:789').isValid()).toBeFalsy()
    ...
    expect(dayjs('2018-02-29', { utc: true }).isValid()).toBeFalsy()
    expect(dayjs('2018-02-29 12:34:56:789', { utc: true }).isValid()).toBeFalsy()
