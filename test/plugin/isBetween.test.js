...
test('bounds can be swapped', () => {
  expect(
    dayjs('2018-01-01').isBetween(dayjs('2017-12-31'), dayjs('2018-01-02'))
  ).toBeTruthy()
  expect(
    dayjs('2018-01-01').isBetween(dayjs('2018-01-02'), dayjs('2017-12-31'))
  ).toBeTruthy()
})

test('bounds can be swapped with inclusivity', () => {
  expect(
    dayjs('2018-01-01').isBetween(
      dayjs('2017-12-31'),
      dayjs('2018-01-01'),
      null,
      '[]'
...
test('is between year', () => {
  ...
  expect(m.isBetween(m, 'year')).toBe(
    false,
...
test('is between month', () => {
  ...
  expect(m.isBetween(m, 'month')).toBe(
    false,
...
test('is between hour', () => {
  ...
  expect(m.isBetween(m, 'hour')).toBe(
    false,
...
test('is between minute', () => {
  ...
  expect(m.isBetween(m, 'minute')).toBe(
    false,
...
test('is between second', () => {
  ...
  expect(m.isBetween(m, 'second')).toBe(
    false,
...
test('is between millisecond', () => {
  ...
  expect(m.isBetween(m, 'millisecond')).toBe(
    false,
