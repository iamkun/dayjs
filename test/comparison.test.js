...
test('is same without units', () => {
  ...
  expect(m.isSame(dayjs(new Date(2012, 3, 2, 3, 5, 5, 10)))).toBe(
    false,
    'year is later'
  )
  expect(m.isSame(dayjs(new Date(2010, 3, 2, 3, 3, 5, 10)))).toBe(
    false,
    'year is earlier'
  )
  expect(m.isSame(dayjs(new Date(2011, 4, 2, 3, 4, 5, 10)))).toBe(
    false,
    'month is later'
  )
  expect(m.isSame(dayjs(new Date(2011, 2, 2, 3, 4, 5, 10)))).toBe(
    false,
    'month is earlier'
  )
  expect(m.isSame(dayjs(new Date(2011, 3, 3, 3, 4, 5, 10)))).toBe(
    false,
    'day is later'
  )
  expect(m.isSame(dayjs(new Date(2011, 3, 1, 3, 4, 5, 10)))).toBe(
    false,
    'day is earlier'
  )
  expect(m.isSame(dayjs(new Date(2011, 3, 2, 4, 4, 5, 10)))).toBe(
    false,
    'hour is later'
  )
  expect(m.isSame(dayjs(new Date(2011, 3, 2, 2, 4, 5, 10)))).toBe(
    false,
    'hour is earlier'
  )
  expect(m.isSame(dayjs(new Date(2011, 3, 2, 3, 5, 5, 10)))).toBe(
    false,
    'minute is later'
  )
  expect(m.isSame(dayjs(new Date(2011, 3, 2, 3, 3, 5, 10)))).toBe(
    false,
    'minute is earlier'
  )
  expect(m.isSame(dayjs(new Date(2011, 3, 2, 3, 4, 6, 10)))).toBe(
    false,
    'second is later'
  )
  expect(m.isSame(dayjs(new Date(2011, 3, 2, 3, 4, 4, 11)))).toBe(
    false,
    'second is earlier'
  )
  expect(m.isSame(dayjs(new Date(2011, 3, 2, 3, 4, 5, 10)))).toBe(
    true,
    'millisecond match'
  )
  expect(m.isSame(dayjs(new Date(2011, 3, 2, 3, 4, 5, 11)))).toBe(
    false,
    'millisecond is later'
  )
  expect(m.isSame(dayjs(new Date(2011, 3, 2, 3, 4, 5, 9)))).toBe(
    false,
...
test('is same year', () => {
  ...
  expect(m.isSame(dayjs(new Date(2011, 5, 6, 7, 8, 9, 10)), 'years')).toBe(
    true,
    'plural should work'
  )
...
test('is same day', () => {
  ...
  expect(m.isSame(dayjs(new Date(2011, 1, 2, 7, 8, 9, 10)), 'days')).toBe(
    true,
    'plural should work'
  )
...
test('is same hour', () => {
  ...
  expect(m.isSame(dayjs(new Date(2011, 1, 2, 3, 8, 9, 10)), 'hours')).toBe(
    true,
    'plural should work'
  )
...
test('is same millisecond', () => {
  ...
  expect(m.isSame(m, 'millisecond')).toBe(
    true,
...
test('is same with invalid moments', () => {
  expect(dayjs(null).isSame(dayjs('2018-01-01'))).toBe(
    false,
    'invalid moments are not considered equal'
  )
  expect(dayjs('2018-01-01').isSame(dayjs(null))).toBe(
    false,
    'invalid moments are not considered equal'
  )
})
...
test('is after year', () => {
  ...
  ).toBe(true, 'end of previous year')
  expect(
    m.isAfter(dayjs(new Date(1980, 11, 31, 23, 59, 59, 999)), 'year')
  ).toBe(true, 'end of year far before')
  expect(m.isAfter(m, 'year')).toBe(
    false,
...
test('is after month', () => {
  ...
  ).toBe(true, 'end of previous month')
  expect(
    m.isAfter(dayjs(new Date(2010, 12, 31, 23, 59, 59, 999)), 'month')
  ).toBe(true, 'later month but earlier year')
  expect(m.isAfter(m, 'month')).toBe(
    false,
...
test('is after day', () => {
  ...
  const mCopy = dayjs(m)
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 7, 8, 9, 10)), 'day')).toBe(
    false,
    'day match'
  )
  expect(m.isAfter(dayjs(new Date(2010, 3, 2, 7, 8, 9, 10)), 'days')).toBe(
    true,
    'plural should work'
  )
  expect(m.isAfter(dayjs(new Date(2012, 3, 2, 7, 8, 9, 10)), 'day')).toBe(
    false,
    'year is later'
  )
  expect(m.isAfter(dayjs(new Date(2010, 3, 2, 7, 8, 9, 10)), 'day')).toBe(
    true,
    'year is earlier'
  )
  expect(m.isAfter(dayjs(new Date(2011, 4, 2, 7, 8, 9, 10)), 'day')).toBe(
    false,
    'month is later'
  )
  expect(m.isAfter(dayjs(new Date(2011, 2, 2, 7, 8, 9, 10)), 'day')).toBe(
    true,
    'month is earlier'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 3, 7, 8, 9, 10)), 'day')).toBe(
    false,
    'day is later'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 1, 7, 8, 9, 10)), 'day')).toBe(
    true,
    'day is earlier'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 0, 0, 0, 0)), 'day')).toBe(
    false,
    'exact start of day'
  )
  ...
  expect(m.isAfter(dayjs(new Date(2011, 3, 3, 0, 0, 0, 0)), 'day')).toBe(
    false,
    'start of next day'
  )
  ...
  expect(m.isAfter(dayjs(new Date(2010, 3, 10, 0, 0, 0, 0)), 'day')).toBe(
    true,
    'later day but earlier year'
  )
  expect(m.isAfter(m, 'day')).toBe(
    false,
...
test('is after hour', () => {
  ...
  expect(m.isAfter(dayjs(new Date(2010, 3, 2, 3, 8, 9, 10)), 'hour')).toBe(
    true,
    'year is earlier'
  )
  ...
  expect(m.isAfter(dayjs(new Date(2011, 1, 2, 3, 8, 9, 10)), 'hour')).toBe(
    true,
    'month is earlier'
  )
  ...
  expect(m.isAfter(dayjs(new Date(2011, 3, 1, 3, 8, 9, 10)), 'hour')).toBe(
    true,
    'day is earlier'
  )
  ...
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 3, 0, 0, 0)), 'hour')).toBe(
    false,
    'exact start of hour'
  )
  ...
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 4, 0, 0, 0)), 'hour')).toBe(
    false,
    'start of next hour'
  )
...
test('is after minute', () => {
  ...
  expect(m.isAfter(m, 'minute')).toBe(
    false,
...
test('is after second', () => {
  ...
  expect(m.isAfter(m, 'second')).toBe(
    false,
...
test('is after without units', () => {
  const m = dayjs(new Date(2011, 3, 2, 3, 4, 5, 10))
  const mCopy = dayjs(m)
  expect(m.isAfter(dayjs(new Date(2012, 3, 2, 3, 5, 5, 10)))).toBe(
    false,
    'year is later'
  )
  expect(m.isAfter(dayjs(new Date(2010, 3, 2, 3, 3, 5, 10)))).toBe(
    true,
    'year is earlier'
  )
  expect(m.isAfter(dayjs(new Date(2011, 4, 2, 3, 4, 5, 10)))).toBe(
    false,
    'month is later'
  )
  expect(m.isAfter(dayjs(new Date(2011, 2, 2, 3, 4, 5, 10)))).toBe(
    true,
    'month is earlier'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 3, 3, 4, 5, 10)))).toBe(
    false,
    'day is later'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 1, 3, 4, 5, 10)))).toBe(
    true,
    'day is earlier'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 4, 4, 5, 10)))).toBe(
    false,
    'hour is later'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 2, 4, 5, 10)))).toBe(
    true,
    'hour is earlier'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 3, 5, 5, 10)))).toBe(
    false,
    'minute is later'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 3, 3, 5, 10)))).toBe(
    true,
    'minute is earlier'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 3, 4, 6, 10)))).toBe(
    false,
    'second is later'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 3, 4, 4, 11)))).toBe(
    true,
    'second is earlier'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 3, 4, 5, 10)))).toBe(
    false,
    'millisecond match'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 3, 4, 5, 11)))).toBe(
    false,
    'millisecond is later'
  )
  expect(m.isAfter(dayjs(new Date(2011, 3, 2, 3, 4, 5, 9)))).toBe(
    true,
    'millisecond is earlier'
  )
...
test('is after invalid', () => {
  ...
  expect(m.isAfter(invalid)).toBe(
    false,
    'valid moment is not after invalid moment'
  )
  expect(invalid.isAfter(m)).toBe(
    false,
  ...
  expect(m.isAfter(invalid, 'milliseconds')).toBe(
    false,
...
test('is after without units', () => {
  const m = dayjs(new Date(2011, 3, 2, 3, 4, 5, 10))
  const mCopy = dayjs(m)
  expect(m.isBefore(dayjs(new Date(2012, 3, 2, 3, 5, 5, 10)))).toBe(
    true,
    'year is later'
  )
  expect(m.isBefore(dayjs(new Date(2010, 3, 2, 3, 3, 5, 10)))).toBe(
    false,
    'year is earlier'
  )
  expect(m.isBefore(dayjs(new Date(2011, 4, 2, 3, 4, 5, 10)))).toBe(
    true,
    'month is later'
  )
  expect(m.isBefore(dayjs(new Date(2011, 2, 2, 3, 4, 5, 10)))).toBe(
    false,
    'month is earlier'
  )
  expect(m.isBefore(dayjs(new Date(2011, 3, 3, 3, 4, 5, 10)))).toBe(
    true,
    'day is later'
  )
  expect(m.isBefore(dayjs(new Date(2011, 3, 1, 3, 4, 5, 10)))).toBe(
    false,
    'day is earlier'
  )
  expect(m.isBefore(dayjs(new Date(2011, 3, 2, 4, 4, 5, 10)))).toBe(
    true,
    'hour is later'
  )
  expect(m.isBefore(dayjs(new Date(2011, 3, 2, 2, 4, 5, 10)))).toBe(
    false,
    'hour is earlier'
  )
  expect(m.isBefore(dayjs(new Date(2011, 3, 2, 3, 5, 5, 10)))).toBe(
    true,
    'minute is later'
  )
  expect(m.isBefore(dayjs(new Date(2011, 3, 2, 3, 3, 5, 10)))).toBe(
    false,
    'minute is earlier'
  )
  expect(m.isBefore(dayjs(new Date(2011, 3, 2, 3, 4, 6, 10)))).toBe(
    true,
    'second is later'
  )
  expect(m.isBefore(dayjs(new Date(2011, 3, 2, 3, 4, 4, 11)))).toBe(
    false,
    'second is earlier'
  )
  expect(m.isBefore(dayjs(new Date(2011, 3, 2, 3, 4, 5, 10)))).toBe(
    false,
    'millisecond match'
  )
  expect(m.isBefore(dayjs(new Date(2011, 3, 2, 3, 4, 5, 11)))).toBe(
    true,
    'millisecond is later'
  )
  expect(m.isBefore(dayjs(new Date(2011, 3, 2, 3, 4, 5, 9)))).toBe(
    false,
    'millisecond is earlier'
  )
...
test('is before year', () => {
  ...
  expect(m.isBefore(dayjs(new Date(2012, 0, 1, 0, 0, 0, 0)), 'year')).toBe(
    true,
    'start of next year'
  )
  expect(
  ...
  ).toBe(false, 'end of year far before')
  expect(m.isBefore(m, 'year')).toBe(
    false,
...
test('is before month', () => {
  ...
  ).toBe(false, 'end of previous month')
  expect(
    m.isBefore(dayjs(new Date(2010, 12, 31, 23, 59, 59, 999)), 'month')
  ).toBe(false, 'later month but earlier year')
  expect(m.isBefore(m, 'month')).toBe(
    false,
...
test('is before day', () => {
  ...
  expect(m.isBefore(dayjs(new Date(2012, 3, 2, 7, 8, 9, 10)), 'day')).toBe(
    true,
    'year is later'
  )
  ...
  expect(m.isBefore(dayjs(new Date(2011, 4, 2, 7, 8, 9, 10)), 'day')).toBe(
    true,
    'month is later'
  )
  ...
  expect(m.isBefore(dayjs(new Date(2011, 3, 3, 7, 8, 9, 10)), 'day')).toBe(
    true,
    'day is later'
  )
  ...
  expect(m.isBefore(dayjs(new Date(2011, 3, 2, 0, 0, 0, 0)), 'day')).toBe(
    false,
    'exact start of day'
  )
  ...
  expect(m.isBefore(dayjs(new Date(2011, 3, 3, 0, 0, 0, 0)), 'day')).toBe(
    true,
    'start of next day'
  )
...
test('is before hour', () => {
  ...
  expect(m.isBefore(dayjs(new Date(2011, 3, 2, 4, 0, 0, 0)), 'hour')).toBe(
    true,
    'start of next hour'
  )
...
test('is before minute', () => {
  ...
  expect(m.isBefore(m, 'minute')).toBe(
    false,
...
test('is before second', () => {
  ...
  expect(m.isBefore(m, 'second')).toBe(
    false,
...
test('is before invalid', () => {
  const m = dayjs()
  const invalid = dayjs(null)
  expect(m.isBefore(invalid)).toBe(
    false,
    'valid moment is not before invalid moment'
  )
  expect(invalid.isBefore(m)).toBe(
    false,
  ...
  expect(m.isBefore(invalid, 'milliseconds')).toBe(
    false,
    'invalid moment milliseconds'
  )
})
