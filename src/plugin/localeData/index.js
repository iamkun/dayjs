...
export default (o, c, dayjs) => {
  ...
  dayjs.monthsShort = () =>
    getShort(getDayjsLocaleObject(), 'monthsShort', 'months', 3)

  dayjs.weekdays = (localeOrder) =>
    getShort(getDayjsLocaleObject(), 'weekdays', null, null, localeOrder)

  dayjs.weekdaysShort = (localeOrder) =>
    getShort(
  ...
  dayjs.weekdaysMin = (localeOrder) =>
    getShort(getDayjsLocaleObject(), 'weekdaysMin', 'weekdays', 2, localeOrder)
}
